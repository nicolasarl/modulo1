...
cat > $TMPOK <<_EOF_
Pivote: 5
Resultado: 59, 88, 57, 6, 23, 78, 76, 21, 8,
_EOF_
...
cat > $TMPOK <<_EOF_
Pivote: -10
Resultado: 59, 88, 57, 6, 3, 23, 78, 76, 21, 8,
_EOF_
...
cat > $TMPOK <<_EOF_
Pivote: -100
Resultado: -38, -19, 37, 34, -17, -48, -34, 34, -40, -46, -24, 44, -27, 43, -10,
_EOF_
ejecutaOK datosEnteros1.dat -100
...
cat > $TMPOK <<_EOF_
Pivote: -100
Resultado: -65, -62, -34, 59, 88, -55, -47, 57, 6, -96, 3, -35, -91, 23, -30, -62, 78, -66, -92, 76, -42, -14, 21, 8, -89,
_EOF_
ejecutaOK datosEnteros2.dat -100
